...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/cements/erp/plants/manageplants/test/integration/FirstJourney",
    "com/cements/erp/plants/manageplants/test/integration/PlantsListJourney",
    "com/cements/erp/plants/manageplants/test/integration/PlantsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
